...
<body>
	...
	<nav class="navbar">
		...
		<ul class="main-nav" id="js-menu">
			<li>
				<a href="#" class="nav-links">Home Pages</a>
			</li>
			<li>
	...
	<div class="footer">
		<div class="head-footer">
			<div class="group-app">
				...
				<div class="app-title">
					<span><a href=""><img class="play-store" src="images/ggstore.PNG"></a><a href=""><img class="appstore" src="css-js/images/appstore.PNG"></a></span>
