...
<body>
	<div class="py-1 bg-black top" style="background: black">
		<div class="container">
				...
				<div class="col-lg-12 d-block">
					<div class="row d-flex">
						...
						<div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right justify-content-end">
							<button class="btn btn-danger"><a href ="#" style="color: white"> Order Online</a></button>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row container d-flex justify-content-center">
						<div class="template-demo mt-2"> 
							<button class="btn btn-outline-primary btn-icon-text"> 
								...
								<button class="btn btn-outline-success btn-icon-text" style="margin-left: 25px"> 
				...
				<div class="container">
					<div class="row mb-5">
						...
						<div class="col-md-6 col-lg-3">
							...
							<p style="color: white">Sign up and get exclusive offers and coupon codes</p>
							<button class="btn btn-danger" style="border-radius: 25px"><a href="#">SIGN UP</a></button>
						</div>
					</div>
					<div class="row">
						<div class="col">
							<a href="#"><span>Privacy Policy </span></a> 
							<a href="#"><span style="margin-left: 20px"> Refund Policy </span></a>
							<a href="#"><span style="margin-left: 20px"> Cookie Policy </span></a>
							<a href="#"><span style="margin-left: 20px"> Terms & Conditions </span></a>
						</div>
						<div class="col">
						</div>
					</div><br>
					<div class="row">
						<div class="col-md-12 text-left">
							...
							<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								...
								<a style="color: red">APV</a> All rights reserved 
