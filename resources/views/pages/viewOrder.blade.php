										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header" style="display: flex;">
													<h4 class="modal-title text-uppercase" style="width: 50%;">{{__('msg.changeState')}}</h4>
													<button type="button" class="close text-right" data-dismiss="modal" aria-label="Close" style="width: 50%;"><span aria-hidden="true" >&times;</span></button>
												</div>
												...
												<div class="chooses text-center">
													<div class="col-md-12">
														<button class="btn btn-danger text-uppercase text-white font-weight-bold btn-state" style="width: 60%; margin : 3px 0px;" state="3">{{__('msg.cancelOrder')}}<i class="fa fa-ban" aria-hidden="true"></i></button>
													</div>
													<div class="col-md-12">
														<button class="btn btn-warning text-uppercase text-white font-weight-bold btn-state" style="width: 60%; margin : 3px 0px;" state="1">{{__('msg.deliveringOrder')}}<i class="fa fa-exchange" aria-hidden="true"></i></button>
													</div>
													<div class="col-md-12">
														<button class="btn btn-success text-uppercase text-white font-weight-bold btn-state" style="width: 60%; margin : 3px 0px;" state="2">{{__('msg.deliveredOrder')}}<i class="fa fa-check-square-o" aria-hidden="true"></i></button>
													</div>
												</div>
