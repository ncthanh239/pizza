	...
	<section class="container blog">
		...
		<section class="banner">
			  ...
			  <div class="bottom-left">
			  	...
			  	<p style="" class="menu-grid"><a href="#" >{{__('store.home')}}</a>
			  ...
			  <div class="top-right">
			  		<a href="#" ><i class='fas fa-shopping-cart' style=""></i></a>
			  		<a href="#" ><i class="fa fa-search" ></i></a>
			  </div>
			  <div class="centered">
			  	<ul>
			  		<li>
			  			<a href="#" class="link-item" >{{__('store.menu_home')}}</a>
			  		</li>
			  		<li>
			  			<a href="#" class="link-item" >{{__('store.menu_blog')}}</a>
			  		</li>
			  		<li>
			  			<a href="#" class="link-item">{{__('store.menu_pages')}}</a>
			  		</li>
			  		<li>
			  			<a href="#" class="link-item">{{__('store.menu_menu')}}</a>
			  		</li>
			  		<li>
			  			<a href="#" class="link-item" >{{__('store.menu_location')}}</a>
			  		</li>
			  		<li>
			  			<a href="#" class="link-item" >{{__('store.menu_contact')}}</a>
			  		</li>
			  	</ul>
			  </div>
		</section>
			...
			<section class="row">
				...
				<section class="col">
                  ...
                  <input type="text" class="form-control" placeholder="Search">
					...
					<section class="box1">
						<img class="img-post-v" src="../images/blog/image_1.jpg" style="">
