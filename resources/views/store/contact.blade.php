					...
					<div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
						...
						<ul class="navbar-nav ml-md-auto">
							<li class="nav-item btn btn-danger btn-order">
								<a class="nav-link text-white font-weight-bold text-uppercase" href="#">order online</a>
							</li>
							<li class="nav-item btn btn-dark btn-cart">
								<a class="text-light" href="#"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
							</li>
		...
		<div class="row row-contact">
			<div class="col-md-6 col-sm-12 col-xs-12">
				<div class="mapping embed-responsive embed-responsive-16by9">
					...
					<button class="btn btn-danger text-white">View in Google map</button>
				</div>
			</div>
			<div class="col-md-6 col-sm-12 col-xs-12">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 info-item">
				<div class="item">
					<ul class="">
						...
						<li class="">
							<button class="btn btn-click btn-danger text-uppercase">sign up</button>
						</li>
					</ul>
				</div>
			</div>
